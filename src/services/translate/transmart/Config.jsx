...
export function Config(props) {
    ...
    const [config, setConfig] = useConfig(
        instanceKey,
        {
            [INSTANCE_NAME_CONFIG_KEY]: t('services.translate.transmart.title', { defaultValue: '腾讯交互翻译' }),
        },
        { sync: false }
    );
    ...
    const handleTest = async () => {
        ...
        try {
            const res = await translate('Hello world', Language.auto, Language.zh_cn);
        ...
        config !== null && (
            ...
            >
                ...
                <div className='text-xs text-default-500 my-2 px-1'>
                    {t('services.translate.transmart.builtin_desc', {
                        defaultValue: '腾讯交互翻译内置接口，无需配置，国内直连高速稳定。',
                    })}
                </div>
